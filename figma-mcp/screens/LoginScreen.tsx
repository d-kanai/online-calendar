...
const imgUndrawBackToSchoolInwc1 = "http://localhost:3845/assets/6fe34af86be7843b94b53955dd377fe77776a67c.svg";
...
export default function LoginScreen() {
  return (
    ...
    >
      ...
      <div
        className="absolute h-[60px] left-6 top-[799px] w-[380px]"
        data-name="Button"
        id="node-1_214"
      >
        <div
          className="absolute bg-[#50c2c9] inset-0 rounded-lg"
          id="node-I1_214-1_121"
        />
        <div
          ...
          id="node-I1_214-1_122"
        >
          <p className="block leading-[1.57] whitespace-pre">Login</p>
        </div>
      </div>
      <div
        ...
        id="node-1_215"
        style={{ left: "calc(20% + 59px)" }}
      >
        <p className="block leading-[normal] whitespace-pre">Welcome back</p>
      </div>
      <div
        className="absolute h-[50px] left-6 top-[553px] w-[380px]"
      ...
      <div
        className="absolute h-[50px] left-6 top-[633px] w-[380px]"
        data-name="input_filed"
        id="node-1_219"
      >
      ...
      <div
        className="absolute font-['Poppins:Regular',_sans-serif] leading-[0] not-italic text-[#000000] text-[16px] text-center text-nowrap top-[878px] translate-x-[-50%]"
        id="node-1_221"
        style={{ left: "calc(20% + 128.5px)" }}
      >
        <p className="leading-[1.57] whitespace-pre">
          <span className="">{`Don't have an account ? `}</span>
          <span className="text-[#50c2c9]">Sign Up</span>
        </p>
      </div>
      <div
        className="absolute h-[138px] top-[328px] w-[184.443px]"
        data-name="undraw_back_to_school_inwc 1"
        id="node-1_241"
        style={{ left: "calc(20% + 37px)" }}
      >
        <img
          alt=""
          className="block max-w-none size-full"
          src={imgUndrawBackToSchoolInwc1}
        />
      </div>
      <div
        className="absolute font-['Poppins:Regular',_sans-serif] leading-[0] not-italic text-[#50c2c9] text-[13px] text-left text-nowrap top-[731px]"
        id="node-1_405"
        style={{ left: "calc(20% + 69px)" }}
      >
        <p className="block leading-[104.667%] whitespace-pre">
          Forget password ?
        </p>
      </div>
    </div>
